...
function App() {
    ...
    // ✅ جایگزین useState و applyTheme و useEffect تم
                                ...
                                <div className="card glass learn-card">
                                    <div className="card-inner">
                                        <svg width="120" height="120" viewBox="0 0 220 220"
                                            ...
                                            <circle cx="110" cy="110" r="90" fill="none" stroke="rgba(255,255,255,0.15)"
                                                    strokeWidth="12"/>
                                            <circle
                                                cx="110" cy="110" r="90"
                                                fill="none"
                                            ...
                                            />
                                            <text x="110" y="110" textAnchor="middle" dominantBaseline="middle"
                                                  fontSize="52" fontWeight="700" fill="white">
                                                12/25
                                            </text>
                                        </svg>
                                    </div>
